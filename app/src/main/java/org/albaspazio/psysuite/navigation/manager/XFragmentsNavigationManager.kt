 ...
 */
object XFragmentsNavigationManager {
    ...
    private val navigationMappings = mapOf(
        NavigationDestination.TEST_FRAGMENT to mapOf("MainFragment"              to R.id.action_mainFragment_to_testFragment),
        NavigationDestination.RESULTS_MANAGER_FRAGMENT to mapOf("MainFragment"   to R.id.action_mainFragment_to_resultsManagerFragment)
    )
