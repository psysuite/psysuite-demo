...
class IllusionTestsFragment  :  BaseFragment(
    ...
    override fun onResume() {
        ...
        binding.btStartFlashIllusion.setOnClickListener {
            if(!isSubjectDFopening) {
                isSubjectDFopening = true
    ...
    private fun setupFragmentResultListener() {
        ...
        parentFragmentManager.setFragmentResultListener(TARGET_FRAGMENT_SUBJECT_REQUEST_CODE.toString(),viewLifecycleOwner) { _, result ->
            ...
            startTest(subject, requireView(), R.id.action_illusionTestsFragment_to_testFragment)
        }
    }
